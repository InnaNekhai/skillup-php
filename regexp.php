...
echo '1: ' .preg_replace('/a.b/', '-', 'ahb acb aeb aeeb adcb axeb') .'<p>';
...
echo '4: ' .preg_replace('/ab+a/', '-', 'aa aba abba abbba abca abea') .'<p>';
...
echo '5: ' .preg_replace('/ab*a/', '-', 'aa aba abba abbba abca abea') .'<p>';
...
echo '6: ' .preg_replace('/ab?a/', '-', 'aa aba abba abbba abca abea') .'<p>';
...
echo '7: ' .preg_replace('/(ab)+/', '-', 'ab abab abab abababab abea') .'<p>';

/*  8. Дана строка 'a.a aba aea'.
Напишите регулярку, которая найдет строку a.a, не захватив остальные.*/

echo '8: ' .preg_replace('/a\.a/', '-', 'a.a aba aea') .'<p>';


/*  9. Дана строка '2+3 223 2223'.
Напишите регулярку, которая найдет строку 2+3, не захватив остальные.*/

echo '9: ' .preg_replace('/2\+3/', '-', '2+3 223 2223') .'<p>';
...
echo '14: ' .preg_replace('/a.+?a/', '!','aba accca azzza wwwwa') .'<p>';
